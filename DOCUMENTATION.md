...
- Perf tuning : https://svn.code.sf.net/p/libtorrent/code/trunk/docs/tuning.html 
- debugging tokio 100% cpu pin : https://tokio.rs/tokio/topics/tracing-next-steps [SUPER USEFUL!]
- memory profiling : dhatr
